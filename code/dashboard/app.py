...
path_regions_local = '/Users/brookjaffe/final-project/data/derived-data/FemaRegionsProcessed.csv'
path_property_local = '/Users/brookjaffe/final-project/data/derived-data/home_values_processed.csv'
path_nfip_local = '/Users/brookjaffe/final-project/data/derived-data/residential_penetration_rates.csv'
...
def load_data(level):
    if level == 'FEMA Region':
        df = pd.read_csv(path_regions_local)
    else:
        df = pd.read_csv(path_property_local)
        df_nfip = pd.read_csv(path_nfip_local)[[
